...
\begin{figure}[htbp]
  \centering
  \begin{minipage}{0.2\textwidth} % Ajuste a largura conforme necessário
    \centering
    \includegraphics[width=\textwidth]{box_plot_idade.png} % Primeira imagem
  ...
  \begin{minipage}{0.2\textwidth}
    \centering
    \includegraphics[width=\textwidth]{sopro.png} % Segunda imagem
